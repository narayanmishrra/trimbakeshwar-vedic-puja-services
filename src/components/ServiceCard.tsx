    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col justify-between">
        <div>
          ...
          {/* Title - Includes Hindi headline in English view */}
          <h3 className="font-serif text-lg sm:text-xl font-bold text-[#7A1E1E] group-hover:text-[#E88921] transition-colors duration-200 mb-1 leading-snug">
            {service.title[lang]}
          </h3>
          {lang === 'en' && (
            <span className="block font-serif text-xs sm:text-sm font-bold text-[#E88921] mb-2">
              {service.title.hi}
            </span>
          )}
        ...
        <div className="border-t border-[#F2E6CE]/40 pt-4 flex items-center justify-between mt-auto">
          ...
          <a
            ...
            className="text-[10px] uppercase tracking-wider font-serif font-bold bg-[#7A1E1E] hover:bg-[#E88921] text-[#FFFDF7] px-3 py-2 rounded-sm border border-[#D4AF37]/20 shadow-sm transition-colors whitespace-nowrap"
          >
